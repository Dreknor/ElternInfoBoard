        ...
        <div class="bg-white rounded-xl shadow-md border border-gray-200 mb-6"
            ...
            <div class="rounded-t-xl flex items-center justify-between text-white px-6 py-4"
                ...
                <div>
                    ...
                    <p class="text-sm text-white/80 mt-1 ml-9">
                        Zeitraum: {{ $periodStart->format('d.m.Y') }} - {{ $periodEnd->format('d.m.Y') }}
                        @if ($selectedYear)
                            <span class="ml-2 inline-flex items-center gap-1 px-2 py-0.5 rounded-full text-xs font-medium bg-white/20">
                ...
                <div x-data="{ showPeriodMenu: false }" class="relative">
                    ...
                    <div x-show="showPeriodMenu"
                         ...
                         style="display: none;">
                        <div class="py-2">
                            <a href="{{ route('pflichtstunden.indexVerwaltung') }}"
                            ...
                            @if (count($availableYears) > 0)
                                ...
                                @foreach ($availableYears as $availableYear)
                                    <a href="{{ route('pflichtstunden.indexVerwaltung', ['year' => $availableYear]) }}"
