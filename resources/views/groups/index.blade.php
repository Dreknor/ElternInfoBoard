    ...
    <div class="container-fluid px-4 py-3 space-y-4">
        @canany(['edit groups', 'delete groups'])
            <div class="flex flex-wrap justify-end gap-2">
                <a href="{{ url('groups') }}?{{ http_build_query(array_filter(['inactive' => ! $showInactive, 'private' => $showPrivate])) }}"
                ...
                <div class="px-4 py-3 border-b"
                    ...
                    <div class="flex items-center justify-between">
                        <h5 class="text-lg font-bold flex items-center gap-2 mb-0" style="color: var(--color-widget-header-text)">
                            ...
                            @canany(['edit groups', 'delete groups'])
                                @if($group->owner_id)
                                    <i class="fas fa-user-shield" style="color: var(--color-widget-accent-from)" title="Private Gruppe"></i>
                                @else
                                    <i class="fas fa-globe" style="color: var(--color-widget-accent-from)" title="Öffentliche Gruppe"></i>
                                @endif
                            @endcanany
