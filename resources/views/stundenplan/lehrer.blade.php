                    ...
                    <div class="mt-2 text-sm text-red-700">
                        <div class="flex flex-wrap gap-2">
                            @foreach($absences as $absence)
                                <div class="px-3 py-1 rounded-full border border-red-200" style="background-color: var(--color-card-bg)">
                                                ...
                                                <div class="rounded-md border-l-4 p-3 {{ $colorClass }}">
                                                    ...
                                                    @if($klassen)
                                                        <div class="text-xs flex items-center mb-1" style="color: var(--color-text-secondary)">
                                                            <i class="fas fa-users mr-1" style="width: 12px; color: var(--color-text-muted)"></i>
                                                            {{ $klassen }}
                                                        </div>
                                                    @endif
                                                    @if($raum)
