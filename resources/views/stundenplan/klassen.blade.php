...
@section('title', '- ' . __('stundenplan.title') . ' - ' . $class)
                        ...
                        <tr class="hover:bg-gray-50 transition-colors">
                            ...
                            @for($tag = 1; $tag <= 5; $tag++)
                                <td class="px-4 py-4 align-top relative">
                                    ...
                                    @if($hasVertretung && $vertretungForSlot)
                                        ...
                                        <div class="rounded-md border-l-4 border-red-500 bg-red-50 p-3 h-full">
                                            <div class="space-y-1">
                                                ...
                                                @endif
                                                @if($vertretungForSlot->lehrer)
                                                    <div class="text-xs text-red-800 flex items-center">
                                                        <i class="fas fa-user-tie text-red-600 mr-1" style="width: 12px;"></i>
                                                        {{ $vertretungForSlot->lehrer }}
                                                    </div>
                                                @endif
                                    ...
                                    @elseif(isset($timetable[$tag][$slot['Stunde']]) && $timetable[$tag][$slot['Stunde']] !== null)
                                        @php
