<div class="border border-gray-200 rounded-lg hover:shadow-lg transition-all duration-200 hover:border-teal-300 flex flex-col" x-data="{ showInfo: false, showMenu: false }">
    <!-- Header -->
    <div class="bg-gradient-to-r from-teal-600 to-teal-700 px-4 py-3 rounded-t-lg @if($liste->active == 0) from-cyan-500 to-cyan-600 @endif">
