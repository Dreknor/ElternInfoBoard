...
class DefaultTheme extends AbstractTheme
{
    ...
    {
        return 'Das klassische Design mit heller Sidebar und blauen Akzenten.';
    }
    ...
    public function variables(): array
    {
        return [
            ...
            '--color-sidebar-hover-bg'  => '#5ea8f2',
            '--color-sidebar-hover-text'=> '#3b4147',
            '--color-sidebar-admin-border' => '#fffff',
            '--color-sidebar-admin-label'  => '#27435e',
            '--color-sidebar-admin-icon'   => '#27435e',
