...
return [
    ...
    'description' => 'Diese Dokumentation enthält alle Informationen, die Sie benötigen, um mit unserer API zu arbeiten.',
    ...
    'auth' => [
        ...
        'extra_info' => 'Das Authentifizierungs-Token muss im Header als Bearer Token übergeben werden. Es authentifiziert den Benutzer und gibt Zugriff auf die API. Das Token ist nur für den Benutzer bestimmt und sollte nicht weitergegeben werden.<br>Wird in den persönlichen Einstellungen generiert.',
    ],
